...
from src.actions.helper_functions import add_max_amount_to_stay_above_exit_CR, can_enter_pool, collateral_to_tokens, tokens_to_collateral
...
class EnterRandomPoolRandomAmount(ActionBundle):
    ...
    def action(self):
        ...
        amount = random.uniform(min_amount, self.balances[self.token_native])
...
class ExitRandomPoolRandomAmount(ActionBundle):
    ...
    def action(self):
        ...
        amount = random.uniform(0, min(pool_holding.pool_tokens, pool_holding.max_amount_to_exit))
...
class WithdrawPoolFeesRandomPool(ActionBundle):
    ...
    def action(self):
        ...
        amount_uba = random.uniform(1, fees_uba)
